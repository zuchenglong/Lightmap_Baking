...
RenderingThread::RenderingThread(GLFWwindow* window)
{
...
void RenderingThread::InitRenderData()
{
	InitRenderBuffer();
	InitShaderProgram();
...
void RenderingThread::InitRenderData(GLuint sharedVBO)
{
...
void RenderingThread::InitRenderBuffer()
{
...
void RenderingThread::InitRenderBuffer(GLuint sharedVBO)
{
	glGenVertexArrays(1, &VAO);
	glBindVertexArray(VAO);
...
void RenderingThread::InitShaderProgram()
{
...
void RenderingThread::InitFrameBuffer()
{
#if 1
...
void RenderingThread::InitColorTexture()
{
#if 1
